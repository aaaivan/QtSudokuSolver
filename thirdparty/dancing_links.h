...
typedef std::vector<size_t> S_Stack;
 ...
 * @param foundSolutions Holds a list of all the solutions found.
 * @param maxSolutionsCount stop the algorithm when this number of solutions is found.
 *
 *
