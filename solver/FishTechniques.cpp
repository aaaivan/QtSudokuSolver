...
void FishTechnique::GetPossibeDefiningRegions(Region* includeRegion, const RegionSet& allowedRegions, std::list<RegionList>& definingSets, unsigned short size, const unsigned short value)
{
...
void FishTechnique::SearchFish()
{
	...
	for (Region* r : mRegionsToSearch)
	{
		...
		if (r->HasConfirmedValue(mCurrentValue))
		{
			...
			GetPossibeDefiningRegions(r, allowedRegions, definingSets, mCurrentSize, mCurrentValue);
