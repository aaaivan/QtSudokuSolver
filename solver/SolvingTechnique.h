...
public:
	...
	/// </summary>
	void SearchFish();
	void GetPossibeDefiningRegions(Region* includeRegion, const RegionSet& allowedRegions, std::list<RegionList>& definingSets, unsigned short size, const unsigned short value);
